...
class Ecu {
  ...
  async processRealTimeData(inverterId, inv) {
    ...
    switch (inv.inverterType) {
      case '01': // YC600 todo  not jet supported
        ...
        //this.createAndSetInverterYC600Objects(inv, 'yc600', inverterId);
        break;
      case '02': // YC1000 todo  not jet supported
        this.adapter.log.warn(`Ecu.processRealTimeData() - unsupported inverterType: ${inv.inverterType}`);
        //this.createAndSetInverterYc1000Objects(inv, 'yc1000', inverterId);
        break;
      case '03': // QS1
        this.createAndSetInverterQs1Objects(inv, 'qs1', inverterId); 
        break;
      default:
  ...
  */
  async createAndSetInverterQs1Objects(inv, inverterTypeStr, inverterId) {
    let prefix = 'inverters.' + inverterTypeStr + '_' + inverterId;
    this.inverterPrefixTable[inverterId] = prefix;
    ...
    this.adapter.log.debug(`ecu.createAndSetInverterQs1Objects() - prefix=${prefix}) - done` );
  }
