...
<<<<<<< HEAD
        this.adapter.log.debug(`prefix=` + prefix + ` i=` + i + ` isl.inverterId[i]=` + isl.inverterId[i]); // #3 debug output improved
=======
        this.adapter.log.debug(`prefix=` + prefix + ` i=` + i + ` isl.inverterId[i]=` + isl.inverterId[i]); // #3 debug output improved
>>>>>>> f5b36532d907b3ecb375133c0823ffbc00950bc8
        if (prefix) {
...
<<<<<<< HEAD
    this.adapter.log.silly('INVERTER_SIGNAL_LEVEL: ' + JSON.stringify(isl));  // #3 debug output improved
=======
    this.adapter.log.silly('INVERTER_SIGNAL_LEVEL: ' + JSON.stringify(isl));  // #3 debug output improved
>>>>>>> f5b36532d907b3ecb375133c0823ffbc00950bc8
  }
