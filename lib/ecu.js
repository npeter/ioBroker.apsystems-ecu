...
*/
  ...
  */
  ...
  async createInverterYc600AndDs3Objects(createObjects, inverterTypeStr, prefix) {
    if (!createObjects || ((inverterTypeStr != INV_TYPE_STR_YC600) && (inverterTypeStr != INV_TYPE_STR_YC600))) {
      this.adapter.log.silly(`Ecu.createInverterYc600AndDs3Objects(${createObjects}, ${prefix}) - ${inverterTypeStr} done`);
      return;
    }
