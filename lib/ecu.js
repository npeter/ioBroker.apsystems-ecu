...
class Ecu {
   ...
   * @param {*} event - 'evNextService', 'evRepeatService'
   */
  ...
  */
  async createAndSetInverterObjects(inv, inverterTypeStr) {
    ...
    await this.adapter.log.debug(`ecu.createAndSetInverterObjects(${inverterTypeStr}) - done` );
  }
  ...
  decodeAndProcessInverterSignalLevel(rsp) {
    ...
    this.adapter.log.silly('ENERGY_OF_WMY: ' + JSON.stringify(isl));
  }
 ...
 * @param {uint8 array with binary data} buf
 ...
 * e.c. [48, 48, 57, 52] -> 94 
 * @param {uint8 array with decimal numbers as ASCII} buf
 ...
 * @param {uint8 array with binary coded decimal data} buf 
 ...
 * @param {uint8 array with binary coded date time data} buf 
 ...
 * e.c. [7, 65] -> '07:41'
 * @param {uint8 array with binary coded time data} buf 
