...
class Ecu {
  ...
  async start(ip, port) {
    ...
    this.adapter.setState('ecu.cmd_energy_of_week', this.cmdEnergyOfWeek = true, true);
    this.adapter.setState('ecu.cmd_energy_of_month', this.cmdEnergyOfMonth = true, true);
    this.adapter.setState('ecu.cmd_energy_of_year', this.cmdEnergyOfYear = true, true);
    this.adapter.setState('ecu.cmd_power_of_day', this.cmdPowerOfDay = true, true);
  ...
  */
  ...
  decodeAndProcessPowerOfDay(rsp) {
    ...
    if (pod.status == '00') {
      ...
      this.adapter.setState('ecu.cmd_power_of_day', this.cmdPowerOfDay=false, true);
    }
    ...
    if (energy.status == '00') {
      ...
      switch (energy.wmy) {
        case '00':
          ...
          this.adapter.setState('ecu.cmd_energy_of_week', this.cmdEnergyOfWeek=false, true);
          break;
        case '01':
          this.adapter.setState('ecu.energy_of_month_list', JSON.stringify(ewmy), true);
          this.adapter.setState('ecu.cmd_energy_of_month', this.cmdEnergyOfMonth=false, true);
          break;
        case '02':
          this.adapter.setState('ecu.energy_of_year_list', JSON.stringify(ewmy), true);
          this.adapter.setState('ecu.cmd_energy_of_year', this.cmdEnergyOfYear=false, true);
          break;
       default:
  ...
  createEcuObjects() {
    ...
    this.adapter.setObjectNotExists('ecu.cmd_energy_of_week', {
      type: 'state',
      common: {
    ...
    this.adapter.setObjectNotExists('ecu.cmd_energy_of_month', {
      type: 'state',
      common: {
    ...
    this.adapter.setObjectNotExists('ecu.cmd_energy_of_year', {
      type: 'state',
      common: {
    ...
    this.adapter.setObjectNotExists('ecu.cmd_power_of_day', {
      type: 'state',
      common: {
