...
class Ecu {
  ...
  scheduleSunsetSunrise() {
    ...
    let tmpObj = {};
    tmpObj['hour'] = this.astroTime.sunrise.getHours();
    ...
    tmpObj['hour'] = this.astroTime.sunset.getHours();
    ...
    this.adapter.setState(this.STATE_SUNRISE, this.astroTime.sunrise, true);
    this.adapter.setState(this.STATE_SUNSET, this.astroTime.sunset, true);
